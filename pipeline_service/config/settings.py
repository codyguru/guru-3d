...
class Settings(BaseSettings):
    ...
    trellis_slat_steps: int = Field(default=28, env="TRELLIS_SLAT_STEPS")
    ...
    num_inference_steps: int = Field(default=10, env="NUM_INFERENCE_STEPS")
    ...
    background_removal_model_id: str = Field(default="neural-guru/BgRemove_2.0", env="BACKGROUND_REMOVAL_MODEL_ID")
